...
ENV ADSBX_JSON_PATH="/run/radarplane-feed" \
    ADSBX_STATS_PATH="/run/radarplane-stats" \
    BEASTPORT=30005 \
    LOG_INTERVAL=900 \
    REDUCE_INTERVAL="0.5" \
    ...
    ADSB_FEED_DESTINATION_HOSTNAME="feed.radarplane.com" \
    ADSB_FEED_DESTINATION_PORT="30001" \
    ADSB_FEED_DESTINATION_TYPE="beast_reduce_plus_out" \
    ADSB_FEED_SECONDARY_DESTINATION_HOSTNAME="feed2.radarplane.com" \
    ADSB_FEED_SECONDARY_DESTINATION_PORT="30001" \
    MLAT_FEED_DESTINATION_HOSTNAME="feed.radarplane.com" \
...
RUN set -x && \
    ...
    touch /boot/radarplane-uuid && \
    chown adsbx:adsbx /boot/radarplane-uuid && \
